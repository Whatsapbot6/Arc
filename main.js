...
global.reloadHandler = async function (restatConn) {
  ...
  conn.bye = '🤣🤣 @user'
  conn.spromote = '@user تمت ترقيته ألى أدمن😻'
  conn.sdemote = '@user 𝙙𝙚𝙢𝙤𝙩𝙚𝙙 𝙮𝙤𝙪 𝙖𝙧𝙚 𝙣𝙤𝙩 𝙖𝙙𝙢𝙞𝙣 𝙖𝙣𝙮𝙢𝙤𝙧𝙚💥'
  conn.sDesc = 'تم تغيير وصف المجموعة \n@desc'
  conn.sSubject = 'تم تغيير اسم مجموعه إلى \n@subject'
  conn.sIcon = 'تم تحديث ايقونة المجموعة '
  conn.sRevoke = 'تغير رابط مجموعه \n@revoke'
